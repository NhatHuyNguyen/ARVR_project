...
lgbt_state_stages_gather %>% 
  ...
  labs(
    title="Prevalence of suicidal thinking among LGBTQA+ (2019) participants by state" 
  ) +
  theme(panel.background = element_blank(),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
...
lgbt_sp_sexual_gather %>%
  ...
  geom_bar(position="dodge", stat="identity", colour="black") + 
  labs(
    title="LGBTQA+ WTI4 (2019) participants who accessed support services by sexual orientation"
  ) +
  theme(panel.background = element_blank(),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
